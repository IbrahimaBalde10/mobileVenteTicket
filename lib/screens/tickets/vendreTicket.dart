...
// class VendreTicketPage extends StatefulWidget {
//   @override
//   _VendreTicketPageState createState() => _VendreTicketPageState();
// }

// class _VendreTicketPageState extends State<VendreTicketPage> {
...
//       await paymentProvider.vendreTicket(
...
//                           decoration:
//                               InputDecoration(labelText: 'Nom du client Principal'),
//                           validator: (value) {
//                             if (value == null || value.isEmpty) {
//                               return 'Veuillez entrer le nom du client Principal';
//                             }
//                             return null;
//                           },
//                         ),
...
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:intl_phone_field/intl_phone_field.dart'; // Utilisation d'une bibliothèque externe pour les numéros internationaux
import '../../models/trajet.dart';
import '../../providers/trajet_provider.dart';
import '../../providers/auth_provider.dart';
  ...
  void _processPayment() async {
    try {
      ...
      await paymentProvider.vendreTicket(
        ...
        passengers:
            _clientControllers.map((controller) => controller.text).toList(),
        telephone: _internationalPhoneNumber ??
            '', // Utilisation du téléphone international
        nom: _nomController.text,
        methodePaiement: _selectedPaymentMethod!,
        dateDepart:
            Provider.of<TrajetProvider>(context, listen: false).selectedDate!,
                        ...
                        ...List.generate(_quantity - 1, (index) {
                          return Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                labelText:
                                    'Nom client additionnel ${index + 1}',
                                border: OutlineInputBorder(),
                              ),
                            ),
                          );
